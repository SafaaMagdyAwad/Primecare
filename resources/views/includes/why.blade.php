...
<section class="why_section layout_padding">
    <div class="container">
      ...
      <div class="why_container">
        <div class="box">
          <div class="img-box">
            <img src="{{asset('assets/images/why1.png')}}" alt="" />
          </div>
        ...
        <div class="box">
          <div class="img-box">
            <img src="{{asset('assets/images/why2.png')}}" alt="" />
          </div>
          <div class="detail-box">
            <h5>
        ...
        <div class="box">
          <div class="img-box">
            <img src="{{asset('assets/images/why3.png')}}" alt="" />
          </div>
          <div class="detail-box">
            <h5>
        ...
        <div class="box">
          <div class="img-box">
            <img src="{{asset('assets/images/why4.png')}}" alt="" />
          </div>
          <div class="detail-box">
            <h5>
              Successful
